...
VALUES
  -- A1 — capítulos do hub (phase4)
  ('a1-cap-01-cumprimentos', 'A1', 1,  'Cumprimentos e apresentações',       'Begrüßungen und Vorstellungen',          'Começar conversas simples, dizer quem você é e entender formal/informal.',        101, true),
  -- A2
  ('a2-cap-13-casos',        'A2', 13, 'Acusativo e dativo sem drama',        'Akkusativ und Dativ',                    'Entender quem recebe a ação e para quem algo acontece.',                         213, true),
  -- B1
  ('b1-cap-23-conectivos',   'B1', 23, 'Conectivos para falar melhor',        'Konnektoren: weil, dass, ob, wenn',      'Ligar ideias, justificar opinião e construir respostas de nível B1.',            323, true),
...
-- ── Phase 4: lições A1/A2/B1 do hub ──────────────
...
VALUES
  -- Hub (phase4): A1 cap-01
  ('a1-l01-cumprimentos-apresentacao', 'a1-l01-ex01', 'a1-cap-01-cumprimentos', 'A1', 'translate_to_de', 'Traduza: Oi! Eu me chamo Rebeca.',                               null, '[]'::jsonb,                                                                          'Hallo! Ich heiße Rebeca.',          'Use Ich heiße para dizer seu nome.',                              10, 1, true),
  ('a1-l01-cumprimentos-apresentacao', 'a1-l01-ex02', 'a1-cap-01-cumprimentos', 'A1', 'choose_option',   'Qual frase é formal?',                                           null, '["Wie geht es dir?","Wie geht es Ihnen?","Wie heißt du?"]'::jsonb,                   'Wie geht es Ihnen?',                'Ihnen/Sie é a forma formal.',                                     10, 2, true),
  ('a1-l01-cumprimentos-apresentacao', 'a1-l01-ex03', 'a1-cap-01-cumprimentos', 'A1', 'fill_blank',      'Complete: Ich komme ___ Brasilien.',                             null, '[]'::jsonb,                                                                          'aus',                               'Origem usa aus: Ich komme aus Brasilien.',                        10, 3, true),
  -- Hub (phase4): A2 cap-13
  ('a2-l13-acusativo-dativo',          'a2-l13-ex01', 'a2-cap-13-casos',        'A2', 'fill_blank',      'Complete: Ich kaufe ___ Kaffee.',                                null, '[]'::jsonb,                                                                          'einen',                             'der Kaffee vira einen Kaffee no acusativo.',                      12, 1, true),
  ('a2-l13-acusativo-dativo',          'a2-l13-ex02', 'a2-cap-13-casos',        'A2', 'choose_option',   'Qual opção usa dativo corretamente com mit?',                    null, '["mit die Karte","mit der Karte","mit den Karte"]'::jsonb,                           'mit der Karte',                     'Mit pede dativo: die Karte -> der Karte.',                        12, 2, true),
  ('a2-l13-acusativo-dativo',          'a2-l13-ex03', 'a2-cap-13-casos',        'A2', 'translate_to_de', 'Traduza: Eu ajudo minha mãe.',                                  null, '[]'::jsonb,                                                                          'Ich helfe meiner Mutter.',          'helfen pede dativo: minha Mutter -> meiner Mutter.',             12, 3, true),
  -- Hub (phase4): B1 cap-23
  ('b1-l23-weil-dass-ob-wenn',         'b1-l23-ex01', 'b1-cap-23-conectivos',   'B1', 'fill_blank',      'Complete: Ich lerne Deutsch, weil ich in Deutschland arbeiten ___.', null, '[]'::jsonb,                                                                    'möchte',                            'Com weil, o verbo conjugado vai ao final.',                       15, 1, true),
  ('b1-l23-weil-dass-ob-wenn',         'b1-l23-ex02', 'b1-cap-23-conectivos',   'B1', 'choose_option',   'Qual frase tem ordem B1 correta?',                               null, '["Ich denke, dass Deutsch ist wichtig.","Ich denke, dass Deutsch wichtig ist.","Ich denke, Deutsch dass wichtig ist."]'::jsonb, 'Ich denke, dass Deutsch wichtig ist.', 'Depois de dass, o verbo conjugado vai ao fim.',            15, 2, true),
  ('b1-l23-weil-dass-ob-wenn',         'b1-l23-ex03', 'b1-cap-23-conectivos',   'B1', 'free_answer',     'Escreva uma frase com weil explicando por que você aprende alemão.', 'Schreiben Sie einen Satz mit weil.', '[]'::jsonb,                                   'weil',                              'Resposta livre: precisa usar weil e verbo no final.',             15, 3, true),
